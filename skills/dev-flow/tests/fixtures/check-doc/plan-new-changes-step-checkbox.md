# test-plan-new-changes-step-checkbox
...
Test Changes field with Step checkbox (format violation).
...
- User Actions:
  1. Check Plan.
- Expected Result: Validation fails with FAIL Changes checkbox error.
