#!/usr/bin/env python3
# test_issue_edit.py - Test cmd_issue_edit function
#
# Test Case: issue edit command (--body-file and --append modes)
#
# Scenarios:
...
class TestIssueEdit(unittest.TestCase):
    """Test cmd_issue_edit function"""
    ...
    def _edit(self, args, issue_info=None):
        ...
        with patch("commands.issue.detect_space_repo", return_value="test/repo"):
            with patch("commands.issue.get_issue_info") as mock_get:
                mock_get.return_value = issue_info or self.ISSUE_INFO
    ...
    def test_write_replace_body(self):
        ...
        try:
            ...
            result, call_args = self._edit(args)
    ...
    def test_write_append_empty_file_error(self):
        ...
        try:
            ...
            with patch("commands.issue.detect_space_repo", return_value="test/repo"):
                with patch("commands.issue.get_issue_info") as mock_get:
                    mock_get.return_value = self.ISSUE_INFO
                    result = cmd_issue_edit(args)
    ...
    def test_write_append_consecutive_separation(self):
        ...
        try:
            ...
            issue_info = dict(self.ISSUE_INFO, body=existing_body)
            ...
            result, call_args = self._edit(args, issue_info=issue_info)
