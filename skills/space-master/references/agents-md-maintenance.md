...
- The AGENTS.md structure follows the template at `templates/agent-rules.md` in this skill directory — the single source of truth for the AGENTS.md structure.
