...
| `workflows/ardot-workflow.md`               | Reference for Example A (Creating a New Landing Page) end-to-end workflow. |
| `workflows/design-to-code-workflow.md`      | Enable only for "landing page to code / export as webpage" tasks. |
| `workflows/extract-style-guide-from-web.md` | Enable only for "referencing competitors / extracting styles" tasks. |
