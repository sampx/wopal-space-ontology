...
|----------------------------------------------|----------------------------------------------------------|
| `workflows/extract-style-guide-from-web.md` | **Core reference**. MUST load for any "extract style from website" task. |
...
| `workflows/ardot-workflow.md`               | Reference for Example D (Setting Up Design Tokens) workflow. |
