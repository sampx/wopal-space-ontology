 ...
 * Copied verbatim from `@deepseek-ai/dsh-fs-sandbox/src/containment.ts`: the
 * deployed runtime closure ships no `src/` trees, so this package cannot
 * deep-import the stock module.
 * @module dsh-sandbox-roots/internal/containment
 */
